...
def dqn2_modified_agent_training(env, q_network, target_q_network, params):
    ...
    limit_nb_negative_before_exploration = float(params["limit_nb_negative_before_exploration"])
    max_nb_negative = float(params["max_nb_negative"])
    ...
    # Train the q-network
    episode_reward_list = train_dqn2_modified_agent(env,
                                        q_network,
                                        target_q_network,
                                        optimizer,
                                        loss_fn,
                                        ...
                                        target_q_network_sync_period=30,
                                        min_reward = min_reward,
                                        limit_nb_negative_before_exploration = limit_nb_negative_before_exploration,
                                        max_nb_negative = max_nb_negative,
                                        data_saver = data_saver)
